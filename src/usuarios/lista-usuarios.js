...
export default class EquipoList extends React.Component {
    ...
    componentDidMount() {
        axios
            .get(`http://alethetwin.online:8080/api/v1/Usuarios/`, {
                headers: {
    ...
    onsubmit(event) {
        ...
        axios
            .post(
                `http://alethetwin.online:8080/api/v1/Usuarios/`,
                {
                            ...
                            >
                                ...
                                <Modal.Body>
                                    ...
                                    <Form.Group className="mb-3">
                                        ...
                                        >
                                            <option selected value="LTC">
                                                LTC
                                            </option>
                                            <option selected value="LIS">
                                                LIS
                                            </option>
                                            <option selected value="LE">
                                                LE
                                            </option>
                                            <option selected value="LRySC">
                                                LRySC
                                            </option>
