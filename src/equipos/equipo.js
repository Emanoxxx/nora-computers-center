...
function Equipo(props){
    ...
    function onsubmitObservacion(event){
        ...
        setValidated(true);
        axios.post(`http://alethetwin.online:8080/api/v1/equipos/${props.numeroInventario}/observaciones/`,{
    ...
    function updateEquipo(id){
      ...
      function deleteEquipo(){
        axios.delete(`http://alethetwin.online:8080/api/v1/Equipos/${props.numeroInventario}`,{
                headers: {
                    "Authorization": "Bearer "+localStorage.getItem("token")
                }
            }
        ...
        if(existe){
            return (
                ...
                (
                  <th>{<><EquipoObservaciones id={props.numeroInventario} nombre={nombre}></EquipoObservaciones> <Button variant="outline-secondary" onClick={toggleModalObservacion}>Escribir observacion</Button>
                <Modal show={showObservacion} onHide={toggleModalObservacion}>
                    <Form onSubmit={onsubmitObservacion} noValidate validated={validated}>
                        <Modal.Header closeButton>
                        <Modal.Title>Observacion</Modal.Title>
                        </Modal.Header>
                        ...
                        <Alert key="warning" variant="warning">
                            ...
                            <Form.Control type="text"   value={props.numeroInventario}/>
                            </Form.Group>
                        ...
                        <Modal.Footer>
                        <Button variant="secondary" onClick={toggleModalObservacion}>
                            Cancelar
                        </Button>
                ...
                <Modal show={show} onHide={toggleModal}>
                    ...
                    <Modal.Body>¿Seguro que desea borrar el equipo <b>{nombre}</b> con numero de inventario <b>{props.numeroInventario}</b>?</Modal.Body>
                    <Modal.Footer>
